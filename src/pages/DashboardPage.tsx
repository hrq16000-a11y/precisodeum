...
import { Briefcase, User, ArrowRight, Users, Settings, PlusCircle, Megaphone } from 'lucide-react';
...
const DashboardPage = () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      description: 'Vá em "Meus Serviços" e adicione os serviços que você oferece.',
