    ...
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <section className="relative overflow-hidden bg-primary py-16 md:py-24">
        ...
        <div className="container relative z-10">
          ...
          >
            <div className="mb-5 inline-flex items-center gap-2 rounded-full bg-white/15 px-4 py-2 text-xs font-semibold text-white backdrop-blur-xs">
            ...
            {geo.city ? (
              <>
                <h1 className="font-display text-3xl font-bold text-white md:text-5xl leading-tight">
                  Profissionais em{' '}
                  <span className="text-accent drop-shadow-xs">{geo.city}</span>
                </h1>
              ...
              <>
                <h1 className="font-display text-3xl font-bold text-white md:text-5xl leading-tight">
                  ...
                  <span className="text-accent drop-shadow-xs">todo o Brasil</span>
                </h1>
                <p className="mt-4 text-base text-white/80 md:text-lg max-w-lg mx-auto">
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:justify-center">
              ...
              <Button size="lg" className="rounded-full gap-2 bg-white/20 hover:bg-white/30 text-white border-2 border-white/40 backdrop-blur-xs text-base px-8 h-12" asChild>
                <Link to="/cadastro">
                  ...
                  <div className="space-y-2">
                    {topCities.map((city, i) => (
                      <Link
                        ...
                        className="flex items-center gap-3 rounded-xl border border-border bg-card p-3.5 shadow-xs transition-all hover:border-primary/40 hover:-translate-y-0.5 hover:shadow-md group"
                      >
                  ...
                  {sortedStates.map(([uf, name]) => {
                    ...
                    return (
                      <Link
                        ...
                        className="flex items-center justify-between rounded-lg border border-border bg-card p-2.5 text-sm transition-all hover:border-primary/40 hover:shadow-xs group"
                      >
