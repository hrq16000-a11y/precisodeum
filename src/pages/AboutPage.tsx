...
const timeline = [
  { year: '2016', title: 'A semente foi plantada', desc: 'A ideia nasceu da indignação com a desvalorização dos profissionais autônomos. Pedreiros, eletricistas, pintores — todos reféns de plataformas que leiloavam seu trabalho pelo menor preço. Continuar escravo do mercado explorador não era uma opção.', icon: <Sparkles className="h-5 w-5" /> },
  ...
  { year: '2018', title: 'Tentativas e aprendizados', desc: 'Primeiras tentativas de criar algo digital, com poucos recursos e muito esforço. Cada "não" recebido de investidores e parceiros fortalecia a convicção de que o projeto era necessário.', icon: <Wrench className="h-5 w-5" /> },
  { year: '2019', title: 'Resistência e persistência', desc: 'O cenário era duro: profissionais cada vez mais desvalorizados, trabalhando 12h por dia por migalhas. A revolta alimentava a missão. Cada história de exploração reforçava o propósito.', icon: <ShieldCheck className="h-5 w-5" /> },
  { year: '2020', title: 'A pandemia travou tudo', desc: 'COVID-19 paralisou o mundo. Obras paradas, profissionais sem renda, famílias passando necessidade. O projeto ficou congelado, mas a chama nunca apagou. Foi o período mais difícil — mas também o que trouxe mais clareza sobre a urgência da plataforma.', icon: <Ban className="h-5 w-5" /> },
  { year: '2021', title: 'Reconstrução em meio ao caos', desc: 'O mundo tentava se reerguer, mas os profissionais autônomos foram os últimos a se recuperar. Sem FGTS, sem seguro, sem nada. A desvalorização atingiu níveis absurdos. O projeto voltou a ser prioridade — não como negócio, mas como missão de vida.', icon: <Heart className="h-5 w-5" /> },
  { year: '2022', title: 'Tudo começou a ganhar corpo', desc: 'O cenário era extremamente desastroso e incerto. A mão de obra nunca esteve tão desvalorizada em todos os ramos e setores. Foi nesse caos que a decisão foi tomada: ou a gente muda isso, ou ninguém muda. O projeto finalmente começou a sair do papel com força total.', icon: <Rocket className="h-5 w-5" /> },
  { year: '2023', title: 'Desenvolvimento e estruturação', desc: 'Meses de desenvolvimento intenso, pesquisa de mercado, conversas com centenas de profissionais. A plataforma foi desenhada para ser diferente: sem leilão, sem intermediação, sem exploração. 100% do lucro para o profissional.', icon: <Calculator className="h-5 w-5" /> },
  { year: '2024', title: 'O MVP ganhou vida', desc: 'Primeira versão da Preciso de Um lançada no Paraná. Cadastro de profissionais, busca por categoria, perfil completo. O sonho de 8 anos finalmente se tornou realidade — imperfeito, mas vivo e cheio de propósito.', icon: <Flag className="h-5 w-5" /> },
  { year: '2025', title: 'Expansão e parcerias', desc: 'Cobertura nacional em todas as capitais, mais de 50 categorias profissionais. Parcerias com SEBRAE, SENAI e FGV para capacitação gratuita. O portal de cursos nasceu para empoderar quem constrói o Brasil com as próprias mãos.', icon: <Globe className="h-5 w-5" /> },
  ...
  { year: '2026', title: 'O futuro é nosso', desc: 'App mobile, inteligência artificial para conexões inteligentes, e muito mais em desenvolvimento. A jornada é longa, mas quem começou na indignação e sobreviveu à pandemia não para por aqui. O melhor ainda está por vir.', icon: <Crown className="h-5 w-5" /> },
];
