...
const timeline = [
  { year: '2016', title: 'A semente foi plantada', desc: 'A ideia nasceu da indignação com a desvalorização dos profissionais autônomos. Pedreiros, eletricistas, pintores — todos reféns de plataformas que leiloavam seu trabalho pelo menor preço. Continuar escravo do mercado explorador não era uma opção. Era preciso criar algo diferente.', icon: <Sparkles className="h-5 w-5" /> },
  { year: '2017', title: 'Os primeiros rascunhos', desc: 'Cadernos, conversas com profissionais nas obras e muita pesquisa. O sonho começou a ganhar forma no papel, mesmo sem recursos. A certeza de que algo precisava mudar era maior que qualquer obstáculo.', icon: <Target className="h-5 w-5" /> },
  { year: '2018', title: 'O primeiro projeto saiu do papel', desc: 'Nasceu o Encontre um Técnico (encontreumtecnico.com) — um catálogo focado em técnicos de informática. Mais de 300 profissionais se juntaram ao projeto, uma equipe inteira revoltada com a situação do mercado. Foi a primeira prova de que a ideia tinha força e que os profissionais precisavam de voz.', icon: <Globe className="h-5 w-5" /> },
  { year: '2019', title: 'Resistência e persistência', desc: 'O cenário era duro: profissionais cada vez mais desvalorizados, trabalhando 12h por dia por migalhas. O Encontre um Técnico crescia organicamente, mas a visão era maior — não deveria se limitar a uma área. A revolta alimentava a missão de abranger todas as mãos de obra.', icon: <ShieldCheck className="h-5 w-5" /> },
  { year: '2020', title: 'A pandemia travou tudo', desc: 'COVID-19 paralisou o mundo. Obras paradas, profissionais sem renda, famílias passando necessidade. O projeto ficou congelado. O rombo e o prejuízo foram enormes — financeiro e emocional. Foi o período mais difícil, mas a chama nunca apagou. A pandemia deixou cicatrizes profundas, mas também trouxe clareza sobre a urgência da plataforma.', icon: <Ban className="h-5 w-5" /> },
  { year: '2021', title: 'Reconstrução em meio ao caos', desc: 'O mundo tentava se reerguer, mas os profissionais autônomos foram os últimos a se recuperar. Sem FGTS, sem seguro, sem nada. A desvalorização atingiu níveis absurdos. O projeto voltou a ser prioridade — não como negócio, mas como missão de vida. Era preciso honrar os 300+ técnicos que acreditaram desde o início.', icon: <Heart className="h-5 w-5" /> },
  { year: '2022', title: 'Tudo começou a ganhar corpo', desc: 'O cenário era extremamente desastroso e incerto. A mão de obra nunca esteve tão desvalorizada em todos os ramos e setores. Foi nesse caos que a decisão foi tomada: ou a gente muda isso, ou ninguém muda. O novo projeto — sem limite de área, sem especificação — começou a tomar forma. Nascia a ideia do "Preciso de Um", para abranger TODAS as mãos de obra.', icon: <Rocket className="h-5 w-5" /> },
  { year: '2023', title: 'Desenvolvimento e estruturação', desc: 'Meses de desenvolvimento intenso, pesquisa de mercado, conversas com centenas de profissionais de todas as áreas. A plataforma foi desenhada para ser diferente: sem leilão, sem intermediação, sem exploração. 100% do lucro para o profissional. O Encontre um Técnico seria reformulado em breve, e o Preciso de Um seria a evolução sem limites.', icon: <Calculator className="h-5 w-5" /> },
  { year: '2024', title: 'O MVP ganhou vida', desc: 'Primeira versão da Preciso de Um lançada no Paraná. Cadastro de profissionais, busca por categoria, perfil completo. O sonho de 8 anos finalmente se tornou realidade — imperfeito, mas vivo e cheio de propósito. Diferente do Encontre um Técnico, agora sem fronteiras de área: do encanador ao designer, do eletricista ao fotógrafo.', icon: <Flag className="h-5 w-5" /> },
  { year: '2025', title: 'Expansão e parcerias', desc: 'Cobertura nacional em todas as capitais, mais de 50 categorias profissionais. Parcerias com SEBRAE, SENAI e FGV para capacitação gratuita. O portal de cursos nasceu para empoderar quem constrói o Brasil com as próprias mãos.', icon: <Trophy className="h-5 w-5" /> },
  { year: '2026', title: 'Comunidade viva e forte', desc: 'Mais de 5.000 profissionais ativos, grupos de apoio no WhatsApp, sistema de gamificação e reconhecimento. Uma comunidade que se ajuda, cresce junta e prova que valorização profissional não é utopia — é realidade.', icon: <Users className="h-5 w-5" /> },
  { year: '2026', title: 'O futuro é nosso', desc: 'App mobile, inteligência artificial para conexões inteligentes, e muito mais em desenvolvimento. A jornada é longa, mas quem começou na indignação, sobreviveu à pandemia e superou o prejuízo não para por aqui. O Encontre um Técnico será reformulado, o Preciso de Um segue crescendo — e o melhor ainda está por vir.', icon: <Crown className="h-5 w-5" /> },
];
