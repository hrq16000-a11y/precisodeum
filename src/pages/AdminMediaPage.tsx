...
import { Trash2, Eye, EyeOff, Search, Image as ImageIcon, RefreshCw, Download, CheckSquare } from 'lucide-react';
                    ...
                    <div className="flex gap-1">
                      ...
                      {item.public_url && (
                        <Button variant="secondary" size="sm" className="h-7 w-7 p-0" asChild>
                          <a href={item.public_url} target="_blank" rel="noopener noreferrer" title="Abrir"><Download className="h-3 w-3" /></a>
                        </Button>
                      )}
