import type { DeterminismClass, HigherOrderComponent, RuntimeHigherOrderDeterminism } from './higherOrderTypes';

export function buildHigherOrderDeterminism(comps: readonly HigherOrderComponent[]): RuntimeHigherOrderDeterminism {
