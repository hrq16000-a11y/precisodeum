import type { HigherOrderComponent, NormalizationClass, RuntimeHigherOrderNormalization } from './higherOrderTypes';

export function buildHigherOrderNormalization(comps: readonly HigherOrderComponent[]): RuntimeHigherOrderNormalization {
