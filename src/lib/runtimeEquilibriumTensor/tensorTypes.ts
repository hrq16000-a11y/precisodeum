...
export interface RuntimeStabilityGeometry {
  readonly nodes: readonly TensorNode[];
  readonly pressure: number;
...
export interface RuntimeEquilibriumTensor {
...
export interface RuntimeCurvatureEnvelope {
  readonly class: CurvatureClass;
...
export interface RuntimeInstabilityDensityEnvelope {
  readonly level: InstabilityDensity;
  readonly score: number;
  readonly amplified: boolean;
  readonly distribution: readonly number[];
}

export interface RuntimeContainmentField {
...
export interface RuntimeTopologyGeometry {
  readonly deformation: TopologyDeformation;
  readonly stress: number;
  readonly fractured: boolean;
  readonly collapsing: boolean;
}

export interface RuntimeConvergenceGradient {
  readonly value: number;
...
export interface RuntimeSingularityEnvelope {
...
export interface RuntimeCollapseGeometry {
  readonly collapsing: boolean;
  readonly cascade: boolean;
  readonly containment: number;
}

export interface TensorRisk {
  readonly code: string;
  readonly severity: TensorSeverity;
  readonly description: string;
}

export interface TensorCertification {
...
export interface RuntimeTensorEnvelope {
  readonly id: string;
  readonly geometry: RuntimeStabilityGeometry;
