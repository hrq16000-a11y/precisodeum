...
/** Re-export da fonte única (src/config/brand.ts). */
export const SITE_BASE_URL = BRAND_BASE_URL;

export const DEFAULT_LOGO_URL = '/lovable-uploads/8a22c45f-f2c2-4ac8-a925-92aecd2b313b.png';
export const DEFAULT_LOGO_SRCSET = '/lovable-uploads/logo-brand-380.webp 380w, /lovable-uploads/logo-brand-710.webp 710w';
export const DEFAULT_LOGO_PNG_SRCSET = '/lovable-uploads/logo-brand-380.png 380w, /lovable-uploads/logo-brand-710.png 710w';
