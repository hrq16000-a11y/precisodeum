    ...
    >
      ...
      <div className="flex flex-1 flex-col p-3 sm:p-[1.25rem] relative">
        ...
        <div className="mt-3 sm:mt-4 flex flex-wrap gap-2">
          {provider.whatsapp && (
            <Button size="sm" className="flex-1 h-8 sm:h-9 text-xs sm:text-sm transition-transform duration-200 hover:scale-[1.02] active:scale-[0.98] bg-[#25D366] hover:bg-[#1da851] text-white border-0" asChild>
              <a
              ...
              >
                <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4 icon-cta icon-bounce" aria-hidden="true">
