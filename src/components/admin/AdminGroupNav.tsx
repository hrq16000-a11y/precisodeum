...
const menuGroups: { label: string; items: GroupItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Limites de Slots', icon: 'LayoutGrid', path: '/admin/sponsor-slot-limits' },
      ...
      { label: 'SEO (Hub)', icon: 'Globe', path: '/admin/seo' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Onboarding Ops (Hub)', icon: 'Telescope', path: '/admin/onboarding-ops' },
    ],
  },
  {
    label: 'Sistema',
    items: [
      ...
      { label: 'Layout Dashboard', icon: 'LayoutDashboard', path: '/admin/dashboard-layout' },
      { label: 'SEO (Hub)', icon: 'Globe', path: '/admin/seo' },
