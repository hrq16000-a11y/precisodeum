...
// BackButton importado e nunca usado — removido (Voltar é global via WizardNav).
      ...
      <div className="space-y-2 rounded-xl border border-border bg-card p-3 shadow-card">
        ...
        <div>
          ...
          <textarea
            ...
            maxLength={400}
            rows={4}
            className={`mt-2 flex w-full rounded-lg border bg-background px-3 py-2.5 text-sm text-foreground outline-hidden transition focus:ring-2 resize-none ${
      ...
      */}
      <div className="flex flex-col gap-2 pt-1">
        <Button
          ...
          className="group h-12 w-full bg-gradient-to-r from-amber-500 via-orange-500 to-emerald-500 text-base font-bold text-white shadow-[0_0_24px_rgba(251,146,60,0.55)] hover:opacity-95 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-amber-400 focus-visible:ring-offset-2"
        >
          Salvar e continuar
    ...
    >
      ...
      <div className="flex flex-col gap-2 pt-1">
        <Button
          ...
          className="group h-12 w-full bg-gradient-to-r from-amber-500 via-orange-500 to-emerald-500 text-base font-bold text-white shadow-[0_0_24px_rgba(251,146,60,0.55)] hover:opacity-95 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-amber-400 focus-visible:ring-offset-2 disabled:opacity-50 disabled:shadow-none"
        >
