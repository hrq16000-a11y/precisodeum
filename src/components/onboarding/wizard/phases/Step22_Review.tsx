    ...
    <div className="mx-auto w-full max-w-md px-4 py-2 space-y-3">
      ...
      <div className="flex items-center gap-2 pt-1">
        ...
        <Button
          type="button"
          onClick={onFinalize}
          className="flex-1 gap-2 bg-gradient-to-r from-amber-500 via-orange-500 to-emerald-500 font-semibold text-white focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-amber-400 focus-visible:ring-offset-2"
        >
