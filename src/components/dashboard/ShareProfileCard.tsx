        ...
        <DialogContent className="max-w-sm p-0 overflow-hidden">
          ...
          <div className="bg-gradient-to-br from-accent/10 via-primary/5 to-background p-6 relative">
            ...
            <div className="relative text-center">
              {/* Avatar */}
              {profile?.avatar_url ? (
                <img src={profile.avatar_url} alt={name} loading="lazy" decoding="async" width={80} height={80} className="h-20 w-20 rounded-2xl object-cover mx-auto border-3 border-card shadow-lg" />
              ) : (
