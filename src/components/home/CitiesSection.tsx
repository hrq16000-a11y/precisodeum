            ...
            return (
              <motion.div key={city.slug} variants={item}>
                ...
                >
                  ...
                  <motion.div
                    className="relative flex h-11 w-11 items-center justify-center rounded-full bg-gradient-to-br from-accent/10 to-accent/20 transition-all duration-300 group-hover:shadow-md"
